  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="bg-neutral-primary-medium border-default-medium rounded-base text-body z-10 w-52 overflow-hidden border bg-white p-2 text-center text-sm font-medium shadow-lg">
        ...
        <Separator />
        <DropdownMenuItem className="text-center hover:bg-gray-200">
          <Link
            to="/user-profile"
        ...
        <DropdownMenuItem className="flex w-full items-center justify-center text-center">
          {/* <Link
            to="/user-profile"
            className="hover:bg-neutral-tertiary-medium hover:text-heading inline-flex w-full items-center rounded p-2"
          >
          ...
          onClick={() => logout()} className="text-body border-default hover:text-heading inline-flex cursor-pointer items-center rounded-sm border bg-white px-4 py-2.5 leading-5 font-medium shadow-xs hover:border-orange-300 hover:bg-orange-300 focus:outline-none">
            <LogOutIcon />
            Logout
          </Button>
        </DropdownMenuItem>
